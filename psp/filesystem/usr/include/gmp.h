...
#define __GMP_CC "arm-arago-linux-gnueabi-gcc -march=armv7-a -mtune=cortex-a8 -mfpu=neon -mfloat-abi=softfp -mthumb-interwork -mno-thumb --sysroot=/OE/arago-tmp/sysroots/armv7a-arago-linux-gnueabi -std=gnu99"
