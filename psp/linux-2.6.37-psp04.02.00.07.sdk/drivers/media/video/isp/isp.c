		     ...
		     struct isp_subdev_i2c_board_info *board_info)
{
	...
	for (first = 1; board_info->board_info; ++board_info, first = 0) {
		...
		// LuoYi_20130521: omap3 camera subdevices debug
		printk(KERN_DEBUG "%s:V4L_DEBUG,module name: %s, addr: 0x%0x\n",__func__,board_info->board_info->type,board_info->board_info->addr);
